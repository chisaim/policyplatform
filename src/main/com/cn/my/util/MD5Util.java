...
public class MD5Util {
	...
	/**
	 * 使用: 直接使用即可,至于具体参数,看下面方法的说明即可; 1. PasswordUtil.MD5Encode();
	 * MD5不可逆简单加密:散列函数-基于HASH算法的编码 2. PasswordUtil.AESEncrypt(); AES加密 3.
	 * PasswordUtil.AESDecrypt(); AES解密 4. PasswordUtil.parseByte2HexStr();
	 * 二进制到16进制 5. PasswordUtil.parseHexStr2Byte(); 16进制到2进制
	 */
